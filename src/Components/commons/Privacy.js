                ...
                <div className={'container'}>
                    <div className={'headline'}>
                        ...
                        <p>Die Nutzung unserer Webseite ist in der Regel ohne Angabe personenbezogener Daten möglich.
                            ...
                            weitergegeben. <br/><br/>
                            In Verbindung mit Ihrem Zugriff werden in unserem Server für Zwecke der Datensicherheit
                            vorübergehend Daten gespeichert, die möglicherweise eine Identifizierung zulassen (zum
                            Beispiel IP-Adresse, Datum, Uhrzeit und Name der angeforderten Datei). Eine Auswertung, mit
                            Ausnahme für statistische Zwecke in anonymisierter Form, erfolgt nicht. <br/><br/>
                            Sollten Sie bei uns Informationsmaterialien bestellen, benötigen wir von Ihnen Name,
                            ...
                            eine Weitergabe an Dritte erfolgt ohne Ihre ausdrückliche Einwilligung nicht.<br/> <br/>
                            Mit der Bestellung willigen Sie in die genannte Verarbeitung Ihrer personenbezogenen Daten
                        ...
                        <br/>
                        <p>Auf unseren Seiten sind Plugins des sozialen Netzwerks Facebook, 1601 South California
                            ...
                            die Facebook-Plugins finden Sie hier: http://developers.facebook.com/docs/plugins/. Wenn Sie
                            ...
                            Ihrer IP-Adresse unsere Seite besucht haben.<br/><br/>
                            Wenn Sie den Facebook “Like-Button” anklicken während Sie in Ihrem Facebook-Account
                            eingeloggt sind, können Sie die Inhalte unserer Seiten auf Ihrem Facebook-Profil verlinken.
                            Dadurch kann Facebook den Besuch unserer Seiten Ihrem Benutzerkonto zuordnen. Wir weisen
                            darauf hin, dass wir als Anbieter der Seiten keine Kenntnis vom Inhalt der übermittelten
                            Daten sowie deren Nutzung durch Facebook erhalten. Weitere Informationen hierzu finden Sie
                            in der Datenschutzerklärung von facebook unter http://de-de.facebook.com/policy.php Wenn Sie
                            nicht wünschen, dass Facebook den Besuch unserer Seiten Ihrem Facebook-Nutzerkonto zuordnen
                        ...
                        <br/>
                        <p>Mithilfe der Google +1-Schaltfläche können Sie Informationen weltweit veröffentlichen. Über
                            ...
                            Stellen auf Websites und Anzeigen im Internet eingeblendet werden. Google zeichnet
                            ...
                            Dieser Name wird in allen Google-Diensten verwendet. In manchen Fällen kann dieser Name auch
                            einen anderen Namen ersetzen, den Sie beim Teilen von Inhalten über Ihr Google-Konto
                            verwendet haben. Die Identität Ihres Google-Profils kann Nutzern angezeigt werden, die Ihre
                        ...
                        <br/>
                        <p>Neben den oben erläuterten Verwendungszwecken werden die von Ihnen bereitgestellten
                        ...
                        <p>Diese Website benutzt Google AdSense, einen Dienst zum Einbinden von Werbeanzeigen der Google
                            ...
                            zusammenführen. Sie können die Installation der Cookies durch eine entsprechende Einstellung
                        ...
                        <p>Diese Website benutzt Google Analytics, einen Webanalysedienst der Google Inc. („Google“).
                            ...
                            einen Server von Google in den USA übertragen und dort gespeichert.<br/>
                            ...
                            Dienstleistungen gegenüber dem Websitebetreiber zu erbringenDie im Rahmen von Google
                            ...
                            http://tools.google.com/dlpage/gaoptout?hl=de. </p><br/>

                        <h2>DATENSCHUTZERKLÄRUNG FÜR DIE NUTZUNG VON PIWIK</h2>
                        <br/>
                        <p>Auf dieser Website werden unter Einsatz der Open-Source-Software Piwik (www.piwik.org) Daten
                            zu Marketing- und Optimierungszwecken gesammelt und gespeichert. Aus diesen Daten werden
                            unter einem Pseudonym Nutzungsprofile erstellt. Hierzu können Cookies eingesetzt werden. Bei
                            ...
                            Wiedererkennung des Internetbrowsers. Die mit der Piwik-Technologie erhobenen Daten werden
                            ohne die gesondert erteilte Zustimmung des Betroffenen nicht dazu benutzt, den Besucher
                            dieser Website persönlich zu identifizieren und nicht mit personenbezogenen Daten über den
                            Träger des Pseudonyms zusammengeführt. Der Datenerhebung und -speicherung kann jederzeit mit
                            Wirkung für die Zukunft widersprochen werden.</p>
                        <br/>
