                                ...
                                <div>
                                    <div className={'row'}>
                                        ...
                                        <div className={'d-block d-sm-block d-md-none col-sm-12 my-auto'}>
                                            <h2 style={{ fontSize: '120%' }}>{this.state.company.company_name.toUpperCase()}</h2>
                                        </div>
                                    </div>
                                        ...
                                        <div className={'col-sm-12 col-md-5 col-lg-4 order-1 order-sm-1 order-md-2'}>
                                            <div className={'row mb-2'}>
                                                ...
                                                <div className={'col-10'}>
                                                    <a href={this.state.company.website}>{this.state.company.website.split('//')[1]}</a>
                                                </div>
                                            </div>
                                            <div className={'row mb-2'}>
                                                <div className={'col-2 text-center'}>
                                            ...
                                            <div className={'row mb-2'}>
                                                ...
                                                <div className={'col-9'}>
                                                    <a href={this.state.company.kununu}>Bewertung auf kununu</a>
                                                </div>
                                            </div>
                                            }
