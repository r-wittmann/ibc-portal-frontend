    ...
    savePosting = () => {
        ...
        if (!this.state.create) {
            ...
            backendService.updatePosting(this.props.match.params.id, updatedPosting)
                ...
                .then(() => toast('Stellenanzeige aktualisiert', { type: 'success' }))
            ...
            backendService.createPosting(posting)
                .then(() => this.props.history.push(`/company/postings`))
                .then(() => toast('Stellenanzeige erstellt', { type: 'success' }))
                .catch(() => toast('Es ist ein Fehler aufgetreten', { type: 'error' }));
        }
    };
                                ...
                                <div>
                                    <div>
                                        ...
                                        <div className={'form-group row'}>
                                            <label className={'col-4 col-form-label'} data-toggle={'tooltip'}
                                                   data-placement={'top'} title={'Ihre angelegten Unternehmen'}>
                                        ...
                                        <div className={'form-group row'}>
                                            ...
                                            <div className={'col-8'}>
                                                <div className={'form-check form-check-inline'}
                                                    ...
                                                    <label htmlFor={'abSofort'} className={'form-check-label'}>
                                                        Ab Sofort
                                                    </label>
                                                </div>
                                                <div className={'form-check form-check-inline'}
                                                    ...
                                                    <label htmlFor={'nachAbsprache'} className={'form-check-label'}>
                                                        Nach Vereinbarung</label>
                                                </div>
                                                <div className={'form-check form-check-inline'}
                                                     style={{ marginLeft: 30 }}>
                                                ...
                                                <select className={'form-control'}
                                                    ...
                                                    {Object.keys(translate.contractDuration()).map(key =>
                                                        <option key={key} value={key}>
                                                            {translate.contractDuration(key)}
                                                        </option>
                                                    )}
                                                </select>
                                            </div>
                                        ...
                                        <div className={'form-group row'}>
                                            ...
                                            <div className={'col-8'}>
                                                <select className={'form-control'}
                                                    ...
                                                    <option value={'active'}>
                                                        Ja (Ist sofort sichtbar für Studenten)
                                                    </option>
                                                    <option value={'deactivated'}>
                                                        Nein (Wird Studenten noch nicht angezeigt)
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div className={'from-group row'}>
                                            ...
                                            <div className={'col-8'}>
                                                <div className={'form-check form-check-inline'}
                                                    ...
                                                    <label htmlFor={'free-text'} className={'form-check-label'}>
                                                        Freitext
                                                    </label>
                                                </div>
                                                <div className={'form-check form-check-inline'}
